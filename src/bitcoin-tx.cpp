...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s plexhive-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  plexhive-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded plexhive transaction") + "\n" +
              "  plexhive-tx [options] -create [commands]   " + _("Create hex-encoded plexhive transaction") + "\n" +
              "\n";
