...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The PlexHive Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "PlexHive Core"
...
#define PACKAGE_STRING "PlexHive Core 0.16.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "plexhive"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://plexhive.com/"
