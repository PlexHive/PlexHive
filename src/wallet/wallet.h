...
#include <consensus/params.h>   // PlexHive: Hive
...
extern bool fWalletUnlockHiveMiningOnly;  // PlexHive: Hive: Unlock for hive mining purposes only.

static const unsigned int DEFAULT_KEYPOOL_SIZE = 1000;
//! -paytxfee default
static const CAmount DEFAULT_TRANSACTION_FEE = 0;
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 2000000 / COIN_SCALE / 10;          // PlexHive: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! -m_discard_rate default
static const CAmount DEFAULT_DISCARD_FEE = 10000 / COIN_SCALE / 10;             // PlexHive: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 100000 / COIN_SCALE / 10;     // PlexHive: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! minimum recommended increment for BIP 125 replacement txs
static const CAmount WALLET_INCREMENTAL_RELAY_FEE = 5000 / COIN_SCALE / 10;     // PlexHive: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
...
public:
    ...
    bool IsHiveCoinBase() const { return tx->IsHiveCoinBase(); }    // PlexHive: Hive

    // PlexHive: Hive: Check if this transaction is a Bee Creation Transaction
...
// PlexHive: Hive: BCT results struct
...
// PlexHive: Hive: Mining optimisations: Bee range structure
struct CBeeRange
{
    std::string txid;
    std::string honeyAddress;
...
public:
    ...
    // PlexHive: Hive: Create a BCT to gestate given number of bees
    ...
    // PlexHive: Hive: Return info for a single BCT known by this wallet, optionally scanning for blocks minted by bees from this BCT
    ...
    // PlexHive: Hive: Return all BCTs known by this wallet, optionally including dead bees and optionally scanning for blocks minted by bees from each BCT
