...
extern bool fWalletUnlockHiveMiningOnly;   // PlexHive: Hive: Encrypted wallet support
    ...
    fCapsLock(false)
{
	...
	// PlexHive: Hive: Support unlocking for hive only
    ...
    switch(mode)
    {
        case Encrypt: // Ask passphrase x2
            ...
            break;
        case UnlockHiveMining: // PlexHive: Hive: Support locked wallets
...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR PLEXHIVE</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         ...
                                         "your plexhive from being stolen by malware infecting your computer.").arg(tr(PACKAGE_NAME)) +
                                         "<br><br><b>" +
    ...
    case Unlock:
        ...
        {
            fWalletUnlockHiveMiningOnly = fHiveOnly;   // PlexHive: Hive: Support locked wallets
            QDialog::accept(); // Success
        }
        break;
    case Decrypt:
