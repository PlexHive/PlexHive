...
#include <qt/hivetablemodel.h>  // PlexHive: Hive
...
#include <policy/policy.h>  // PlexHive: Hive: For GetVirtualTransactionSize
...
WalletModel::WalletModel(const PlatformStyle *platformStyle, CWallet *_wallet, OptionsModel *_optionsModel, QObject *parent) :
    ...
    hiveTableModel(0),  // PlexHive: Hive
    ...
    cachedNumBlocks(0)
{
    ...
    hiveTableModel = new HiveTableModel(platformStyle, wallet, this);  // PlexHive: Hive
...
WalletModel::UnlockContext WalletModel::requestUnlock(bool hiveOnly)
{
    ...
    // PlexHive: Hive: Support unlock for hive mining only
    ...
    return UnlockContext(this, valid, was_locked && !fWalletUnlockHiveMiningOnly); // PlexHive: Hive: Support unlock for hive mining only
}
