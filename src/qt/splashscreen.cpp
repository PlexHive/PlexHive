    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int paddingRight            = 10;   // PlexHive: Fix ugly spacing on splash screen
    int paddingTop              = 50;
    ...
    QString titleText       = tr("PlexHive");  // PlexHive: Show the pretty name, not package name
    ...
    // PlexHive: Adjusted to show whole logo
