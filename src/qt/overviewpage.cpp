...
#include <qt/hivedialog.h>      // PlexHive: Hive: For formatLargeNoLocale()
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    if(model && model->getOptionsModel())
    {
        ...
        // PlexHive: Hive: Connect summary updater
...
// PlexHive: Hive: Update the hive summary
...
void OverviewPage::updateDisplayUnit()
{
    if(walletModel && walletModel->getOptionsModel())
    {
        ...
        // PlexHive: Hive: Update CAmounts in hive summary
        ui->rewardsPaidLabel->setText(
            BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rewardsPaid)
            + " "
            + BitcoinUnits::shortName(walletModel->getOptionsModel()->getDisplayUnit())
...
// PlexHive: Hive: Handle bee button click
