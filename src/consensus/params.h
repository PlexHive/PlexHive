...
#include <script/script.h>  // PlexHive: Needed for CScript
#include <amount.h>         // PlexHive: Needed for CAmount
...
enum DeploymentPos
{
    ...
    DEPLOYMENT_HIVE,        // PlexHive: Hive: Deployment
    DEPLOYMENT_HIVE_1_1,    // PlexHive: Hive: 1.1 Deployment
    DEPLOYMENT_MINOTAURX,   // PlexHive: MinotaurX+Hive1.2: Deployment
...
struct Params {
    ...
    // PlexHive: General consensus params
    ...
    // PlexHive: Hive-related consensus params
