...
const char* ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_ILLEGAL_FORKID:                 // PlexHive: Replay attack prevention error message
            return "Illegal use of SIGHASH_FORKID";
        case SCRIPT_ERR_MUST_USE_FORKID:                // PlexHive: Replay attack prevention error message
