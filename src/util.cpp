...
const char * const BITCOIN_CONF_FILENAME = "plexhive.conf";
const char * const BITCOIN_PID_FILENAME = "plexhived.pid";
...
const CLogCategoryDesc LogCategories[] =
{
    ...
    {BCLog::HIVE, "hive"},  // PlexHive: Hive
    {BCLog::MINOTAURX, "minotaurx"},  // PlexHive: MinotaurX+Hive1.2
    {BCLog::ALL, "1"},
    {BCLog::ALL, "all"},
};
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PlexHive";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/PlexHive";
#else
    // Unix
    return pathRet / ".plexhive";
#endif
#endif
}
...
// PlexHive: Hive: Mining Optimisations: Return number of virt cores
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // PlexHive: Check for untranslated substitution to make sure Litecion Core copyright is not removed by accident
