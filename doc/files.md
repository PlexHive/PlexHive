...
* plexhive.conf: contains configuration settings for plexhived or plexhive-qt
* plexhived.pid: stores the process id of plexhived while running
...
* debug.log: contains debug information and general logging generated by plexhived or plexhive-qt
